...
<script type="text/javascript">
	...
	//삭제
	function fn_delete() {
		if (confirm("삭제시 해당 상담에 신청한 인원들도 삭제 됩니다. 삭제하시겠습니까?")) {
			document.frm_del.action = "./mentor_reg_proc_Del.asp";
...
<form method="post" id="frm_del" name="frm_del">
	<input type="hidden" id="del_mentor_no" name="del_mentor_no" value="<%=mentor_no%>">
</form>
